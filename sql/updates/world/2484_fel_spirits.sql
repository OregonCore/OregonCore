...
UPDATE `creature_template` SET `unit_flags` = '2' WHERE `entry` = '22444';
UPDATE `gameobject_template` SET `size` = '3' WHERE `entry` = '185298';
UPDATE `gameobject_template` SET `flags` = '4' WHERE `entry` = '185298';

DELETE FROM `spell_script_target` WHERE entry = 39184;
INSERT INTO `spell_script_target` VALUES
(39184,1,16878);

UPDATE `item_template` SET `spellcooldown_1` = '60000' WHERE `entry` = '31772';

DELETE FROM `script_texts` WHERE entry = -1900130;
INSERT INTO `script_texts` (`entry`,`content_default`,`content_loc1`,`content_loc2`,`content_loc3`,`content_loc4`,`content_loc5`,`content_loc6`,`content_loc7`,`content_loc8`,`sound`,`type`,`language`,`emote`,`comment`) VALUES
(-1900130,'Vengeance will not be yours, $N!',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,0,0,0,'SAY_SP');