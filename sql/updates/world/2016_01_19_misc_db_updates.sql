-- Fix battleground orientation for horde
UPDATE battleground_template SET AllianceStartO = 3.16312, HordeStartO = 0.715504 WHERE id = 1;
UPDATE battleground_template SET AllianceStartO = 3.14159, HordeStartO = 0.151581 WHERE id = 2;
UPDATE battleground_template SET AllianceStartO = 3.91571, HordeStartO = 0.813671 WHERE id = 3;
UPDATE battleground_template SET AllianceStartO = 3.03123, HordeStartO = 0.055761 WHERE id = 7;

-- Fix baseattacktime for Battleguard Sartura
UPDATE `creature_template` SET `BaseAttackTime` = 1200 WHERE `entry` = 15516;

-- Landen Stillwell gossip
...
(7482,0,0,'Listen to me, human. I care nothing for your plight, but you have something I require. Tell me where to find the bloodforged ingots.',1,1,7483,0,0,0,'');
