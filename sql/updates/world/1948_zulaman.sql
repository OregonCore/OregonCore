-- Massive Gate
--insert nto gameobject values (18539, 186728, 568, 1, 1, 120.073, 1605.38, 62.7175, 3.12571, 0, 0, 0.999968, 0, 100, 1)
...
-- Harrison Jones
update creature_template set position_x = 95.3293, position_y = 1653.27, position_z = 42.0219, ScriptName = 'npc_harrison_jones' where entry = 24358;
