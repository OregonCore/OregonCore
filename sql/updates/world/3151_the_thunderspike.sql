...
UPDATE `creature_template` SET  `faction_A`='14', `faction_H`='14', `AIName`='SmartAI' WHERE `entry`=21319;
...
(21319, 0, 1, 'Hah!  The Thunderspike is mine.  Die!', 12, 0, 100, 0, 0, 0, 0, 'Gor Grimgut');