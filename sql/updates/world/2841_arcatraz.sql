...
(@CGUID+0, 21304, 552, 3, 197.9555, -86.81332, -10.01739, 5.8294, 7200, 0, 0),
(@CGUID+1, 21304, 552, 3, 206.3423, -98.27836, -10.02623, 2.6529, 7200, 0, 0),
(@CGUID+2, 21304, 552, 3, 270.7674, -66.62302, 22.45336, 5.742133, 7200, 0, 0),
(@CGUID+3, 21304, 552, 3, 226.1842, -162.0961, -10.03523, 0.3490658, 7200, 0, 0),
(@CGUID+4, 21304, 552, 3, 264.271, -191.2798, -10.02188, 5.61996, 7200, 0, 0),
(@CGUID+5, 21304, 552, 3, 293.8853, 70.93681, 22.52617, 1.553343, 7200, 0, 0),
(@CGUID+6, 21304, 552, 3, 291.632, 70.58091, 22.52693, 2.007129, 7200, 0, 0),
(@CGUID+7, 21304, 552, 3, 285.4156, 127.1274, 22.29513, 4.694936, 7200, 0, 0),
(@CGUID+8, 21304, 552, 3, 257.3438, 155.5679, 22.33209, 4.712389, 7200, 0, 0),
(@CGUID+9, 21304, 552, 3, 298.8479, 151.7484, 22.31051, 5.707227, 7200, 0, 0),
(@CGUID+10, 20879, 552, 3, 285.5186, 146.1547, 22.31179, 5.794493, 7200, 0, 0),
(@CGUID+11, 20880, 552, 3, 301.7973, 127.4436, 22.31079, 1.308997, 7200, 0, 0),
(@CGUID+12, 20880, 552, 3, 305.7355, 148.0587, 24.8633, 3.979351, 7200, 0, 0);
...
INSERT INTO `creature` (`guid`, `id`, `map`, `spawnMask`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `MovementType`) VALUES
(@CGUID+0, 20869, 552, 3, 264.2865, -61.32112, 22.45335, 5.288348, 7200, 0, 0),
(@CGUID+1, 20869, 552, 3, 336.5143, 27.42666, 48.42604, 3.839724, 7200, 0, 0),
(@CGUID+2, 20869, 552, 3, 253.942, 131.8811, 22.39496, 0.7679449, 7200, 0, 0),
(@CGUID+3, 20869, 552, 3, 255.4978, 158.9143, 22.36194, 5.410521, 7200, 0, 0),
(@CGUID+4, 20869, 552, 3, 395.413, 18.19484, 48.29602, 2.495821, 7200, 0, 0);
