-- Fix startup errors from previous commits
DELETE FROM creature_addon WHERE guid = 86097;
DELETE FROM creature_ai_scripts WHERE creature_id = 21718;

-- Add SAI support for Sha'tari skyguard text
...
(23335, 0, 0, 'You''re a peach!  I''ll make sure that the ray is properly cared for.', 12, 0, 100, 0, 0, 0, 0, 'Skyguard Khatie'),
(23335, 0, 1, 'Wow!  Thanks for bringing it all the way back here.  You didn''t have to do that.', 12, 0, 100, 0, 0, 0, 0, 'Skyguard Khatie'),
