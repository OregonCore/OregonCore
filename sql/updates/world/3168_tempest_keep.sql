...
DELETE FROM `creature_linked_respawn` WHERE `guid` IN (12546, 12545, 12460, 12459, 12547, 12548, 12571, 12572);
...
-- Fix faction for Nether Scryer
UPDATE creature_template SET faction_A = 16, faction_H = 16 WHERE entry = 20045;

-- Update creature data
UPDATE creature SET curhealth = 180000 WHERE guid IN (12463,12464,86941,86942,86943,86944,86945,86939);
UPDATE creature SET curhealth = 230000 , curmana = 48465 WHERE guid IN (86946,86947,86948,86949);
UPDATE creature SET curhealth = 230000 , curmana = 49635 WHERE guid IN (86940,12465);
UPDATE creature SET curhealth = 143600 , curmana = 48465 WHERE guid IN (86953,86952,86950,86951);