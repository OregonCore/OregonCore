...
bool GossipHello_npc_spirit_of_olum(Player* player, Creature* pCreature)
{
...
bool GossipSelect_npc_spirit_of_olum(Player* player, Creature* pCreature, uint32 sender, uint32 action)
{
