...
struct instance_black_temple : public ScriptedInstance
{
    ...
    void OnCreatureCreate(Creature* pCreature, bool /*add*/)
    {
        ...
        {
        case 22887:
            Najentus = pCreature->GetGUID();
            break;
        case 23089:
            Akama = pCreature->GetGUID();
            break;
        case 22990:
            Akama_Shade = pCreature->GetGUID();
            break;
        case 22841:
            ShadeOfAkama = pCreature->GetGUID();
            break;
        case 22898:
            Supremus = pCreature->GetGUID();
            break;
        case 22917:
            IllidanStormrage = pCreature->GetGUID();
            break;
        case 22949:
            GathiosTheShatterer = pCreature->GetGUID();
            break;
        case 22950:
            HighNethermancerZerevor = pCreature->GetGUID();
            break;
        case 22951:
            LadyMalande = pCreature->GetGUID();
            break;
        case 22952:
            VerasDarkshadow = pCreature->GetGUID();
            break;
        case 23426:
            IllidariCouncil = pCreature->GetGUID();
            break;
        case 23499:
            BloodElfCouncilVoice = pCreature->GetGUID();
            break;
        }
    }
    ...
    void OnGameObjectCreate(GameObject* pGo, bool /*add*/)
    {
        ...
        case 185882:
            ...
            if (Encounters[1] == DONE)HandleGameObject(0, true, pGo);
            break;
        case 185478:
            ShadeOfAkamaDoor = pGo->GetGUID();
            break;
        case 185480:
            CommonDoor = pGo->GetGUID();
            if (Encounters[3] == DONE)HandleGameObject(0, true, pGo);
            break;
        case 186153:
            TeronDoor = pGo->GetGUID();
            if (Encounters[3] == DONE)HandleGameObject(0, true, pGo);
            break;
        case 185892:
            GuurtogDoor = pGo->GetGUID();
            if (Encounters[4] == DONE)HandleGameObject(0, true, pGo);
            break;
        case 185479:
            TempleDoor = pGo->GetGUID();
            if (Encounters[5] == DONE)HandleGameObject(0, true, pGo);
            break;
        case 185482:
            MotherDoor = pGo->GetGUID();
            if (Encounters[6] == DONE)HandleGameObject(0, true, pGo);
            break;
        case 185481:
            CouncilDoor = pGo->GetGUID();
            if (Encounters[7] == DONE)HandleGameObject(0, true, pGo);
            break;
        case 186152:
    ...
    uint64 GetData64(uint32 identifier)
    {
        ...
        case DATA_GAMEOBJECT_NAJENTUS_GATE:
            return NajentusGate;
        ...
        case DATA_GAMEOBJECT_SUPREMUS_DOORS:
            return MainTempleDoors;
        case DATA_BLOOD_ELF_COUNCIL_VOICE:
            return BloodElfCouncilVoice;
        }
