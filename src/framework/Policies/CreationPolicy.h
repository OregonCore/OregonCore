...
namespace Oregon
{
     ...
     */
    template <class T>
        class OREGON_DLL_DECL OperatorNew
    {
        public:
     ...
     */
    template <class T>
        class OREGON_DLL_DECL LocalStaticCreation
    {
        union MaxAlign
        {
            char t_[sizeof(T)];
     ...
     */
    template<class T>
        class OREGON_DLL_DECL CreateUsingMalloc
    {
        public:
            static T* Create()
            {
    ...
    template<class T, class CALL_BACK>
        class OREGON_DLL_DECL CreateOnCallBack
    {
        public:
            static T* Create()
            {
