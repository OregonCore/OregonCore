...
struct OREGON_DLL_DECL npc_millhouse_manastormAI : public ScriptedAI
{
...
struct OREGON_DLL_DECL npc_warden_mellicharAI : public ScriptedAI
{
...
struct OREGON_DLL_DECL mob_zerekethvoidzoneAI : public ScriptedAI
{
