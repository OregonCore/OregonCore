...
struct OREGON_DLL_DECL boss_priestess_delrissaAI : public ScriptedAI
{
...
struct OREGON_DLL_DECL boss_priestess_guestAI : public ScriptedAI
{
...
struct OREGON_DLL_DECL boss_kagani_nightstrikeAI : public boss_priestess_guestAI
{
    //Rogue
...
/*struct OREGON_DLL_DECL mob_fizzleAI : public ScriptedAI
{
...
struct OREGON_DLL_DECL boss_ellris_duskhallowAI : public boss_priestess_guestAI
{
    //Warlock
...
struct OREGON_DLL_DECL boss_eramas_brightblazeAI : public boss_priestess_guestAI
{
    //Monk
...
struct OREGON_DLL_DECL boss_yazzaiAI : public boss_priestess_guestAI
{
    //Mage
...
struct OREGON_DLL_DECL boss_warlord_salarisAI : public boss_priestess_guestAI
{
    //Warrior
...
/*struct OREGON_DLL_DECL mob_sliverAI : public ScriptedAI
{
...
struct OREGON_DLL_DECL boss_garaxxasAI : public boss_priestess_guestAI
{
    //Hunter
...
struct OREGON_DLL_DECL boss_apokoAI : public boss_priestess_guestAI
{
    //Shaman
...
struct OREGON_DLL_DECL boss_zelfanAI : public boss_priestess_guestAI
{
    //Engineer
...
//struct OREGON_DLL_DECL mob_high_explosive_sheepAI : public ScriptedAI
//{
