...
struct OREGON_DLL_DECL mob_stolen_soulAI : public ScriptedAI
{
...
struct OREGON_DLL_DECL boss_exarch_maladaarAI : public ScriptedAI
{
...
struct OREGON_DLL_DECL mob_avatar_of_martyredAI : public ScriptedAI
{
