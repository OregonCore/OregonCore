...
struct OREGON_DLL_DECL boss_nexusprince_shaffarAI : public ScriptedAI
{
...
struct OREGON_DLL_DECL mob_ethereal_beaconAI : public ScriptedAI
{
    ...
    void JustDied(Unit* Killer)
    {
        Unit *Shaffar = FindCreature(ENTRY_SHAFFAR, 100, me);
        if (Shaffar)
            ((boss_nexusprince_shaffarAI*)(((Creature*)Shaffar)->AI()))->RemoveBeaconFromList(me);
    }
...
struct OREGON_DLL_DECL mob_ethereal_apprenticeAI : public ScriptedAI
{
