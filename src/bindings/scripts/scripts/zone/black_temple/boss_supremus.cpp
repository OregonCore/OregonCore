...
struct OREGON_DLL_DECL molten_flameAI : public NullCreatureAI
{
...
struct OREGON_DLL_DECL boss_supremusAI : public ScriptedAI
{
...
struct OREGON_DLL_DECL npc_volcanoAI : public ScriptedAI
{
