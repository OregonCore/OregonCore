...
struct OREGON_DLL_DECL mob_doom_blossomAI : public ScriptedAI
{
...
struct OREGON_DLL_DECL mob_shadowy_constructAI : public ScriptedAI
{
...
struct OREGON_DLL_DECL boss_teron_gorefiendAI : public ScriptedAI
{
