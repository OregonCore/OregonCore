/* Copyright (C) 2006 - 2008 ScriptDev2 <https://scriptdev2.svn.sourceforge.net/>
    ...
    struct OREGON_DLL_DECL boss_lady_blaumeuxAI : public ScriptedAI
    {
  ...
  //baron rivendare
   ...
   struct OREGON_DLL_DECL boss_rivendare_naxxAI : public ScriptedAI
   {
   ...
   struct OREGON_DLL_DECL boss_thane_korthazzAI : public ScriptedAI
   {
   ...
   struct OREGON_DLL_DECL boss_sir_zeliekAI : public ScriptedAI
   {
