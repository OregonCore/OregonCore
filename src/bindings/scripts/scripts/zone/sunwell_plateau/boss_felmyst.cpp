...
struct OREGON_DLL_DECL boss_felmystAI : public ScriptedAI
{
    ...
    void HandleFlightSequence()
    {
        ...
        case 2:{
            ...
            if (!pTarget) pTarget = Unit::GetUnit((*m_creature), pInstance->GetData64(DATA_PLAYER_GUID));
            if (pTarget)
            {
    ...
    void DespawnSummons(uint32 entry)
    {
...

        {
            ...
            Oregon::AllCreaturesOfEntryInRange check(m_creature, entry, 100);
...
struct OREGON_DLL_DECL mob_felmyst_vaporAI : public ScriptedAI
{
...
struct OREGON_DLL_DECL mob_felmyst_trailAI : public ScriptedAI
{
