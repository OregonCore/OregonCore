...
struct OREGON_DLL_DECL boss_kiljaedenAI : public Scripted_NoMovementAI
{
    ...
    void Reset()
    {
        ...
        Kalec = ((Creature*)Unit::GetUnit(*me, pInstance->GetData64(DATA_KALECGOS_KJ)));
    ...
    void EnterEvadeMode()
    {
        ...
        if (pInstance){
            Creature* Control = ((Creature*)Unit::GetUnit(*me, pInstance->GetData64(DATA_KILJAEDEN_CONTROLLER)));
            if (Control)
...
struct OREGON_DLL_DECL mob_felfire_portalAI : public Scripted_NoMovementAI
{
...
struct OREGON_DLL_DECL mob_volatile_felfire_fiendAI : public ScriptedAI
{
...
struct OREGON_DLL_DECL mob_armageddonAI : public Scripted_NoMovementAI
{
...
struct OREGON_DLL_DECL mob_sinster_reflectionAI : public ScriptedAI
{
