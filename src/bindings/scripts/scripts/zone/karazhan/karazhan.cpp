...
struct OREGON_DLL_DECL npc_barnesAI : public npc_escortAI
{
...
struct OREGON_DLL_DECL npc_image_of_medivhAI : public ScriptedAI
{
...
struct OREGON_DLL_DECL npc_Spectral_Retainer : public ScriptedAI
{
