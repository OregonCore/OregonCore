...
struct OREGON_DLL_DECL npc_taskmaster_fizzuleAI : public ScriptedAI
{
...
struct OREGON_DLL_DECL npc_twiggy_flatheadAI : public ScriptedAI
{
...
struct OREGON_DLL_DECL npc_wizzlecrank_shredderAI : public npc_escortAI
{
