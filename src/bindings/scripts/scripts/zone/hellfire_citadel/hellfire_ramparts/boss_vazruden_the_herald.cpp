...
struct OREGON_DLL_DECL boss_nazanAI : public ScriptedAI
{
...
struct OREGON_DLL_DECL boss_vazrudenAI : public ScriptedAI
{
    ...
    void EnterCombat(Unit *who)
    {
        switch(rand()%3)
        {
            ...
            default: DoScriptText(SAY_AGGRO_3, me); break;
        }
    }
...
struct OREGON_DLL_DECL boss_vazruden_the_heraldAI : public ScriptedAI
{
...
struct OREGON_DLL_DECL mob_hellfire_sentryAI : public ScriptedAI
{
