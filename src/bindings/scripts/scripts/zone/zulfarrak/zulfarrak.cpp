...
struct OREGON_DLL_DECL npc_sergeant_blyAI : public ScriptedAI
{
    ...
    uint32 Revenge_Timer;                                   //this is wrong, spell should never be used unless m_creature->getVictim() dodge, parry or block attack. OREGON support required.
...
struct OREGON_DLL_DECL npc_weegli_blastfuseAI : public ScriptedAI
{
