...
struct OREGON_DLL_DECL npc_grimstoneAI : public npc_escortAI
{
...
struct OREGON_DLL_DECL mob_phalanxAI : public ScriptedAI
{
...
ScriptedInstance *pInstance;
/*
struct OREGON_DLL_DECL npc_dughal_stormwingAI : public npc_escortAI
{
...
Player* PlayerStart;
/*
struct OREGON_DLL_DECL npc_marshal_windsorAI : public npc_escortAI
{
...
int wp = 0;
/*
struct OREGON_DLL_DECL npc_marshal_reginald_windsorAI : public npc_escortAI
{
...
/*
struct OREGON_DLL_DECL npc_tobias_seecherAI : public npc_escortAI
{
...
struct OREGON_DLL_DECL npc_rocknotAI : public npc_escortAI
{
