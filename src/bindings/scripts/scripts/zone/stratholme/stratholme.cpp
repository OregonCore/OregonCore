...
struct OREGON_DLL_DECL mob_freed_soulAI : public ScriptedAI
{
...
struct OREGON_DLL_DECL mob_restless_soulAI : public ScriptedAI
{
...
struct OREGON_DLL_DECL mobs_spectral_ghostly_citizenAI : public ScriptedAI
{
