...
struct OREGON_DLL_DECL npc_chicken_cluckAI : public ScriptedAI
{
...
struct OREGON_DLL_DECL npc_dancing_flamesAI : public ScriptedAI
{
...
struct OREGON_DLL_DECL npc_doctorAI : public ScriptedAI
{
    uint64 Playerguid;
...
struct OREGON_DLL_DECL npc_injured_patientAI : public ScriptedAI
{
...
struct OREGON_DLL_DECL npc_guardianAI : public ScriptedAI
{
...
struct OREGON_DLL_DECL npc_steam_tonkAI : public ScriptedAI
{
...
struct OREGON_DLL_DECL npc_tonk_mineAI : public ScriptedAI
{
...
struct OREGON_DLL_DECL npc_snake_trap_serpentsAI : public ScriptedAI
{
