...
void detail_log(const char * str, ...)
{
    ...
    Oregon::Singleton<Log>::Instance().outDetail(buf);
}
...
void debug_log(const char * str, ...)
{
    ...
    Oregon::Singleton<Log>::Instance().outDebug(buf);
}
...
void error_log(const char * str, ...)
{
    ...
    Oregon::Singleton<Log>::Instance().outError(buf);
}
...
void error_db_log(const char * str, ...)
{
    ...
    Oregon::Singleton<Log>::Instance().outErrorDb(buf);
}
