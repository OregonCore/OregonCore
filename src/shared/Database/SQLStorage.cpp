...
const char CreatureInfosrcfmt[] = "iiiiiiiisssiiiiiiiiiifffiffiiiiiiiiiiiffiiiiiiiiiiiiiiiiiiisiilliiis";
const char CreatureInfodstfmt[] = "iiiiiiiisssiiiiiiiiiifffiffiiiiiiiiiiiffiiiiiiiiiiiiiiiiiiisiilliiii";
