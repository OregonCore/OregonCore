...
bool LoadScriptingModule(char const* libName)
{
    ...
    if (  !(testScript->ScriptsInit         =(scriptCallScriptsInit         )OREGON_GET_PROC_ADDR(testScript->hScriptsLib,"ScriptsInit"         ))
        ||!(testScript->OnLogin             =(scriptCallOnLogin             )OREGON_GET_PROC_ADDR(testScript->hScriptsLib,"OnLogin"             ))
        ||!(testScript->OnLogout            =(scriptCallOnLogout            )OREGON_GET_PROC_ADDR(testScript->hScriptsLib,"OnLogout"            ))
        ||!(testScript->OnPVPKill           =(scriptCallOnPVPKill           )OREGON_GET_PROC_ADDR(testScript->hScriptsLib,"OnPVPKill"           ))
