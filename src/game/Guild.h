...
class Guild
{
    public:
        ...
        const uint64& GetLeader() const { return m_LeaderGuid; }
        ...
        void   LogBankEvent(SQLTransaction& trans, uint8 LogEntry, uint8 TabId, uint32 PlayerGuidLow, uint32 ItemOrMoney, uint8 ItemStackCount=0, uint8 DestTabId=0);
        void   RenumBankLogs();
