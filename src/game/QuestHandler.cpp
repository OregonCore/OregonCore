...
void WorldSession::HandleQuestgiverStatusQueryOpcode(WorldPacket & recv_data)
{
    ...
    switch(questgiver->GetTypeId())
    {
        case TYPEID_UNIT:
        {
            sLog.outStaticDebug("WORLD: Received CMSG_QUESTGIVER_STATUS_QUERY for npc, guid = %u",uint32(GUID_LOPART(guid)));
        ...
        {
            sLog.outStaticDebug("WORLD: Received CMSG_QUESTGIVER_STATUS_QUERY for GameObject guid = %u",uint32(GUID_LOPART(guid)));
...
void WorldSession::HandleQuestgiverAcceptQuestOpcode(WorldPacket & recv_data)
{
    ...
    sLog.outStaticDebug("WORLD: Received CMSG_QUESTGIVER_ACCEPT_QUEST npc = %u, quest = %u", uint32(GUID_LOPART(guid)), quest);
...
void WorldSession::HandleQuestgiverQuestQueryOpcode(WorldPacket & recv_data)
{
    ...
    uint32 quest;
    recv_data >> guid >> quest;
    sLog.outStaticDebug("WORLD: Received CMSG_QUESTGIVER_QUERY_QUEST npc = %u, quest = %u", uint32(GUID_LOPART(guid)), quest);
...
void WorldSession::HandleQuestQueryOpcode(WorldPacket & recv_data)
{
    uint32 quest;
    recv_data >> quest;
    sLog.outStaticDebug("WORLD: Received CMSG_QUEST_QUERY quest = %u",quest);
...
{
    sLog.outStaticDebug("WORLD: Received CMSG_QUESTGIVER_STATUS_MULTIPLE_QUERY");
