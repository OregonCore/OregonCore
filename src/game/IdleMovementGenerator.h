...
class OREGON_DLL_SPEC IdleMovementGenerator : public MovementGenerator
{
    public:
...
class OREGON_DLL_SPEC RotateMovementGenerator : public MovementGenerator
{
    public:
...
class OREGON_DLL_SPEC DistractMovementGenerator : public MovementGenerator
{
    public:
...
class OREGON_DLL_SPEC AssistanceDistractMovementGenerator : public DistractMovementGenerator
{
    public:
